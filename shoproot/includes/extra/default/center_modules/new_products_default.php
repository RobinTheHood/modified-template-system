<?php
/* -----------------------------------------------------------------------------------------
   $Id: new_products_default.php 13676 2021-08-11 13:21:52Z GTB $
...
if (!$module_smarty->is_cached($modCoreTemplate->getPath('module/new_products_default.html'), $cache_id) || !$cache) {
