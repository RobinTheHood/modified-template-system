...
/* -----------------------------------------------------------------------------------------
   $Id: gift_cart.php 14501 2022-05-31 09:03:37Z GTB $
...
$gift_smarty->assign('tpl_path', $modCoreTemplate->getUrl(''));
...
$module = $modCoreTemplate->fetch($gift_smarty, 'module/gift_cart.html');
