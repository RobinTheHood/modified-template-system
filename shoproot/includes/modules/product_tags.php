<?php
/* -----------------------------------------------------------------------------------------
   $Id: product_tags.php 14501 2022-05-31 09:03:37Z GTB $
...
if (!$module_smarty->is_cached($modCoreTemplate->getPath('module/product_tags.html'), $cache_id) || !$cache) {
...
$module = $modCoreTemplate->fetch($module_smarty, 'module/product_tags.html', $cache_id);
