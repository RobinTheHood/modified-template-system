<?php
/* -----------------------------------------------------------------------------------------
   $Id: sub_content_listing.php 14501 2022-05-31 09:03:37Z GTB $
...
if (!$module_smarty->is_cached($modCoreTemplate->getPath('module/sub_content_listing.html'), $cache_id) || !$cache) {
  $result = false;
