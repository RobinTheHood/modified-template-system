<?php
/* -----------------------------------------------------------------------------------------
   $Id: listing_filter.php 14501 2022-05-31 09:03:37Z GTB $
...
$filter_smarty->assign('tpl_path', $modCoreTemplate->getUrl(''));
...
$module_filter = '';
if (!$module_smarty->is_cached($modCoreTemplate->getPath('module/listing_filter.html'), $cache_id) || !$cache) {
  $filter_set_dropdown = '';
